function main_cal_stress(Draw_Models, quantity1, quantity2, fig_num, avg_q, gen_data, insetplot)
global q_dim
tic
...
% ---- choose model
Models      = {'DNS'; 'POD'; 'ML '; 'SMG'; 'VMS'; 'DS ' };
if nargin==0
    Draw_Models = {'DNS'; 'POD'; 'ML '; ' '; ' '; ' '}; % determine what models are plotting
    quantity    = 'u';
    fig_num     = 1;
    avg_q       = [];
end
...
T_set_dns  = n_per_start:n_per;  T_set_smg  =T_set;
delta_t    = 0.075;
skip       = 5;
...
for i=1:length(Models) % ---- model
    ...
    if cmp_res(i)==1
        if i==1 % ---- for DNS
            ...
            fprintf(1, 'DNS: \n');
        elseif i==4 % ---- for SMG
            str1 = 'm-'; str2=[str2;'S-POD-ROM  ']; tt=tt+1;
            %             C_smg  = 500;
            ...
            fprintf(1, 'SMG: \n');
        elseif i==5 % ---- for VMS
            str1 = 'g-'; str2=[str2;'VMS-POD-ROM']; tt=tt+1;
            %             No_Large = 1;
            %             C_vms    = 1100; %Cav*10^6
            %             R_c      = 4;
            %             Alg      = 2;
        ...
        elseif i==3 % ---- for ML
            ...
            fprintf(1, 'ML : \n');
        elseif i==6 % ---- for DS
            str1 = 'r-'; str2=[str2;'DS-POD-ROM ']; tt=tt+1;
        ...
        elseif i==2 % ---- for POD-G
            str1 = 'k-'; str2=[str2;'POD-G-ROM  ']; tt=tt+1;
            %             Dir_load = ['Matrices/r',num2str(q_dim),'/connective_matrix145_193_17_',...
        ...
        if isempty(avg_q)~=1
            avgname   = ['Matrices/AVG/r',num2str(q_dim), 'Stress_',quantity1,quantity2,'_',avg_q,'_model_',num2str(i)];
        ...
        if insetplot==1
            ...
            if i==1||i==2      % plot DNS with POD-G
                figure(fig_num+5);
